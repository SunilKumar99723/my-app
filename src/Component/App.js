import './App.css';
import AppUseContextHook from './Pages/HooksUseContext/AppUseContextHook';
import DataFetchingFromJson from './Pages/HookUseEffect/DataFetchingFromJson';
import DataFetchingFromJsonWithID from './Pages/HookUseEffect/DataFetchingFromJsonWithID';
import DataFetchingFromJsonWithIdOnButtonClick from './Pages/HookUseEffect/DataFetchingFromJsonWithIdOnButtonClick';
import IncrementDecrement from './Pages/IncrementDecrementCounter/IncrementDecrement';
import Menu from './Pages/MenuItems/Menu';
// import MenuContainer from './Pages/MenuItems/MenuContainer';
...
function App() {
  ...
  return (
    ...
    {/* <IncrementDecrement/> */}
    <AppUseContextHook/>
    <DataFetchingFromJson/>
    <DataFetchingFromJsonWithID/>
    <DataFetchingFromJsonWithIdOnButtonClick/>
    {/* <Menu/> */}
       {/* <MenuContainer/> */}
